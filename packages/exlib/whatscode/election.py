...
from .extension_based import guess_by_extension
from .guess_by_popularity import language_by_popularity
from .keyword_based import guess_by_keywords
from .known_languages import FILE_EXTENSIONS
from .parsing_based import parses_as_xml
from .pygments_based import language_by_pygments
from .regex_based import language_by_regex_features
from .shebang_based import language_by_shebang
from .tag_based import match_tag_to_languages
